                    ...
                    <form method="POST" action="{{ route('questions.update', $question->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('answer_type') is-invalid @enderror" id="answer_type" name="answer_type" required>
                                <option value="single_choice" {{ old('answer_type', $question->answer_type) === 'single_choice' ? 'selected' : '' }}>Single Choice</option>
                                <option value="multiple_choice" {{ old('answer_type', $question->answer_type) === 'multiple_choice' ? 'selected' : '' }}>Multiple Choice</option>
                                <option value="open_ended" {{ old('answer_type', $question->answer_type) === 'open_ended' ? 'selected' : '' }}>Open Ended</option>
                            </select>
                        ...
                        <div id="options-container" 
                            ...
                            @if($question->options)
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" name="options[]" value="{{ $option }}" placeholder="Option 1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('correct_answer') is-invalid @enderror" id="correct_answer" name="correct_answer" value="{{ old('correct_answer', $question->correct_answer) }}" required>
